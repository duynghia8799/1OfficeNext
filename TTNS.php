                ...
                <?php get_template_part('template-parts/tabs/animation_tab', null, array('name' => 'TTNS-chuanhoa', 'tabs' => array(
                    ...
                    [
                        ...
                        'content_panel' => '
                            ...
                            <p>Tự động theo dõi và nhắc nhở các mốc quan trọng như gia hạn, sắp <br/>hết hạn hoặc hết hiệu lực hợp đồng, giúp HR chủ động xử lý kịp thời, <br/>hạn chế bỏ sót và đảm bảo tính liên tục trong quản lý nhân sự</p>
                        ',
                    ],
                ))); ?>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <img class="demo" src="<?get_template_directory_uri()?>" alt="">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-12">
                <div class="box-content">
                    <h1 class="title-section">Loại bỏ hoàn toàn sai sót, chậm trễ trong phê duyệt, quản lý hồ sơ</h1>
                    <div class="content">
                        <div class="item">
                            <img src="<?get_template_directory_uri()?>" alt="">
                            <div>
