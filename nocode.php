        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="video-container">
                    ...
                    <button class="play-button" data-bs-toggle="modal" data-bs-target="#nocodeVideoModal">
                        <img src="<?php echo get_template_directory_uri()?>/assets/images/icons/playbtn_white.svg" alt="">
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <p class="sub-title-section">Hỗ trợ người dùng phát triển ứng dụng và quy trình bám sát tư duy vận hành, đảm bảo <br/>triển khai linh hoạt trong khi vẫn duy trì khả năng kiểm soát trên toàn hệ thống</p>
                ...
                <?php get_template_part('template-parts/tabs/animation_tab',null, array('name' => 'nocode-tuduy-tabs','tabs' => array(
                    ...
                    [
                        ...
                        'icon' => '',
                        'content_panel' => '
                            <div class="content-panel yellow">
                                <div class="panel">
...
<section class="top-footer center">
    <img class="top-footer-bg" src="<?= get_template_directory_uri() . '/assets/images/ai_light_bg_darkbrown.svg' ?>" alt="">
    <div class="container">
        <div class="row">
            <div class="content">
                <h1 class="title-section">Trải nghiệm nền tảng No-code. Tăng tốc phát triển và <br/>thích ứng linh hoạt với mọi thay đổi kinh doanh</h1>
